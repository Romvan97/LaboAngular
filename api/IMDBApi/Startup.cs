    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           services.AddSwaggerGen(b =>
            {
                b.SwaggerDoc("v2", new OpenApiInfo { Title = "MyProject", Version = "v1.0.0" });
                ...
                b.AddSecurityDefinition("Bearer", securitySchema);
                ...
                b.AddSecurityRequirement(securityRequirement);
